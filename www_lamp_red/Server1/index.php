<html>
<head>
<TITLE>Using virtual server <? echo $_SERVER['HTTP_HOST']; ?> and Server Node <? echo $_SERVER['SERVER_ADDR']; ?> (Node #2)</TITLE>
...
<p><font face=Calibri>The <i>index.php</i> page is from <font color="C00000"><b>Node #2</font></b><br>
<font face=Calibri>Virtual Server IP Address:</font>&nbsp;<font face=Calibri size=4><? echo $_SERVER['HTTP_HOST']; ?></font><br>
<font face=Calibri>Real Server Address/port:</font>&nbsp;<font face=Calibri size=4 color="C00000"><b><? echo $_SERVER['SERVER_ADDR']; ?>:<? echo $_SERVER['SERVER_PORT']; ?></b></font><br>
<?php
